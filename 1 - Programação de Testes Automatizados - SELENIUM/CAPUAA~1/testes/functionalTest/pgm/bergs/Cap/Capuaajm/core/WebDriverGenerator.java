...
public class WebDriverGenerator {
    public static ChromeDriver getChromeDriver() {
        ...
        String chromeDriverPath = null;
            ...
            if (matchingDrivers.isPresent()) {
                ...
                chromeDriverPath = diretorioDrivers.concat("\\119.0\\chromedriver.exe");
            }
        ...
        ChromeDriver chromeDriver = configurarChromeDriver();
    ...
    private static ChromeDriver configurarChromeDriver() {
