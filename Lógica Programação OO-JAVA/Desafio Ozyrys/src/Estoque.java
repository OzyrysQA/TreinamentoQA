...
public class Estoque {
    ...
    public static Boolean baixarEstoque(int id, int quantidade) {
        ...
        {
            System.out.println(String.format("O produto %s possui  %d unidade(s) em estoque, você solicitou %d unidade(s), então não será possível adicionar esse item no seu carrinho.", produto.getNome(),  produto.getQuantidadeEstoque(), quantidade));
            return false;
        }
